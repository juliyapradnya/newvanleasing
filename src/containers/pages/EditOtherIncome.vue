  ...
  >
    ...
    <b-form
      ...
      <b-form-group :label="$t('additional.payment-profile')"  class="has-top-label">
        ...
        />
        <b-form-invalid-feedback v-if="!$v.payment_profile.required">Vendor name is required!</b-form-invalid-feedback>
      </b-form-group>
    ...
    <template slot="modal-footer">
      <b-button variant="outline-secondary" @click="hideModal('editotherincome')">{{ $t('pages.cancel') }}</b-button>
      <b-button
        :class="{
        ...
        variant="primary" type="submit" form="editIncomeForm"
